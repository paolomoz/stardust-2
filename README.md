...
`v0.2.0` — complete refactor. v1 (the four-stage greenfield design tool) is
preserved at [`adobe/skills/plugins/stardust`](https://github.com/adobe/skills/tree/main/plugins/stardust)
and is unrelated to this version's surface.
